...
- для боундед-контекста "Определение характеристик воркера, основанное на результате тестирования" должны быть также высокие показатели **scalability** и **agility**, так как топ-менеджмент планирует продавать этот функционал другим компаниям 
